...
public class ClaimSearchResultVo {
	...
	public float getSurveyPrice() {
		return surveyPrice;
	}
	public void setSurveyPrice(float surveyPrice) {
	...
	public float getSurTotal() {
		return surTotal;
	}
	public void setSurTotal(float surTotal) {
